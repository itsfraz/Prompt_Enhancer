  ...
  return (
    <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 animate-in fade-in slide-in-from-bottom-4 duration-500">
      ...
      <div className="flex flex-col space-y-4">
        ...
        <div className="p-6 rounded-2xl bg-blue-50 dark:bg-blue-500/5 border border-blue-200 dark:border-blue-500/20 min-h-[200px] text-slate-900 dark:text-slate-100 whitespace-pre-wrap leading-relaxed shadow-xl shadow-blue-500/5 transition-colors duration-300">
          {result.enhanced}
          <div className="mt-4 flex justify-end">
             <button 
                onClick={() => navigator.clipboard.writeText(result.enhanced)}
                className="text-xs text-blue-600 dark:text-blue-400 hover:text-blue-700 dark:hover:text-blue-300 flex items-center gap-1 font-semibold"
             >
